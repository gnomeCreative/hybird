...
public:
    ...
    void computeShearRate(const double feq[], const double& turbConst, const double& plasticVisc, const double& yieldStress, const bool& nonNewtonian, const bool& turbulenceOn);
...
public:
    ...
    void setSolidIndex(unsigned int& ind);
};
